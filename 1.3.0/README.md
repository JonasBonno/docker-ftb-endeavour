...
<code>docker run --name [name of your data container] jonasbonno/ftb-endeavour:1.3.0 echo 'Data-only container'</code>

Running ftb-endeavour server:
<code>docker run --tty=true --interactive=true --detach=true --name [name of your container] --volumes-from [name of your data container] --publish=[port on your host]:25565 jonasbonno/ftb-endeavour:1.3.0</code>
